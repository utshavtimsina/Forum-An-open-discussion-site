		...
		$result=mysqli_query($conn,$sql);
				...
				while($rows=mysqli_fetch_array($result)) 
				{
						...
						if($isimage=='1'){
							...
							$sql="select * from uploaded_images  where question_id='$question_id'";
					...
					$src1='none';
						...
						$data[] = array("isimage"=>$isimage,"src1"=>$src1,"question_id" => $question_id,"question_text" => $question_text,  "member_id" => $member_id, "upvote" => $upvote, "downvote" => $downvote, "date" => $date, "username" => $username,"profile_pic" => $profile_pic,"total_replies" => $total_replies );
